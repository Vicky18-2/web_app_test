...
public class UpdateTicket extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        RequestDispatcher requestDispatcher = servletContext.getRequestDispatcher("/updateTicket.jsp");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        ticketService.updateTicket(ticket.getTicketPrice(), ticket.getSession(),  ticket.getId(),ticket.getIdSeat(), ticket.getIdColumn(),ticket.isTicketStatus());
        resp.sendRedirect("/getTicket?idTicket=" + ticket.getId());
    }
}
