...
public class InsertSession extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        RequestDispatcher requestDispatcher = servletContext.getRequestDispatcher("/insertSession.jsp");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        sessionService.insertSession(session.getIdSession(),session.getSessionDate(),session.getSessionTime(),session.getHall(),session.getFilm());
